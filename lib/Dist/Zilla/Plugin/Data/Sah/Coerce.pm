package Dist::Zilla::Plugin::Data::Sah::Coerce;
...
sub munge_files {
    ...
    for my $file (@{ $self->found_files }) {
        next unless $file->name =~ m!\Alib/(Data/Sah/Coerce/.+)\.pm\z!;
        (my $pkg = $1) =~ s!/!::!g;
...
1;
# ABSTRACT: Plugin to use when building Data::Sah::Coerce::* distribution
...
This plugin is to be used when building C<Data::Sah::Coerce::*> distribution. It
...
L<Pod::Weaver::Plugin::Data::Sah::Coerce>
